...
from pdftabextract.common import ROTATION, SKEW_X, SKEW_Y, DIRECTION_VERTICAL
...
from pdftabextract.clustering import (find_clusters_1d_break_dist, calc_cluster_centers_1d,
                                      zip_clusters_and_values, get_adjusted_cluster_centers)
from pdftabextract.extract import make_grid_from_positions, fit_texts_into_grid, datatable_to_dataframe


# Constants
DATAPATH = r'C:/Users/vish0/OneDrive/Desktop/capTableExtraction/img'
OUTPUTPATH = 'img/out/'
MIN_COL_WIDTH = 30
image_file_path = os.path.abspath('C:/Users/vish0/OneDrive/Desktop/capTableExtraction/img/11.png')

if len(sys.argv) != 2:
    print("Usage: python script_name.py input_xml.xml")
    sys.exit(1)
...
for p_num, p in pages.items():
    ...
    iproc_obj = imgproc.ImageProc(image_file_path)
...
ooutput_files_basename = INPUT_XML[:INPUT_XML.rindex('.')]
